...
<div class="row">
    <div class="col-lg-12">
        <div class="box">
            ...
            <button type="submit" id="btn-simpan" class="btn btn-primary btn-sm btn-flat pull-right btn-simpan"><i class="fa fa-floppy-o"></i> Simpan Transaksi</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('#diterima').on('input', function () {
        ...
        // Periksa apakah kolom Diterima kosong dan nonaktifkan/aktifkan tombol sesuai keadaannya
        if ($(this).val() == 0) {
